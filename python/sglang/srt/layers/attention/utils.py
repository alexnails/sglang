...
try:
    ...
    def create_flashmla_kv_indices_triton(
        ...
        num_pages_loop = tl.cdiv(
            kv_end - kv_start, FLASHMLA_CREATE_KV_BLOCK_SIZE_TRITON
        )
    ...
    def _triton_not_available(*args, **kwargs):
        raise RuntimeError("This function requires triton to be installed")

    create_flashinfer_kv_indices_triton = _triton_not_available
    create_flashmla_kv_indices_triton = _triton_not_available
    concat_and_cast_mha_k_kernel = _triton_not_available
    pad_sequence_with_mask_kernel = _triton_not_available
    seqlens_expand_kernel = _triton_not_available
