...
def get_hybrid_layer_ids(
    ...
    if "Llama4ForConditionalGeneration" in model_architectures:
        ...
        # Any other value is excluded from BOTH lists, which is how a model whose
        # layer stack interleaves non-attention blocks (e.g. ZAYA1's MoE layers)
        # marks "this layer holds no KV" -- it must not report 0, because these
        # lists size the SWA sub-pools, not just index them.
