...
// guard is applied. The opaque value barrier makes the scaled f32 values
// explicit conversion inputs and prevents that transform while allowing each
// architecture to select its supported f32 -> fp16 instructions.
